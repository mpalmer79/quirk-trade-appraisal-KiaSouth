...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Kia South"],
    ["successTitle", "¡Gracias! - Quirk Kia South"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Kia South se pondrá en contacto con usted en breve."]
  ]);
